...
localStorageData,} 
 ...
 console.log('text',index)
    const handlerDeleteIcon = (index) => {
        console.log('textIdex',index);
        
        //  const update = localStorageData.filter((_, index) => index !== indexRemove);
        // setLocalStorageDatta(update);
        // localStorage.setItem("SaveInputValue", JSON.stringify(update));
     };
  return (
    <div class="fixed inset-0 z-40 min-h-full overflow-y-auto overflow-x-hidden transition flex 
    items-center">
    ...
    <div class="relative w-full cursor-pointer pointer-events-none transition my-auto p-4">
        <div
            ...
            <button tabindex="-1" type="button" onClick={()=>setConfarmDelete(false)}class="absolute top-2 right-2 rtl:right-auto rtl:left-2">
            ...
            <div class="space-y-2">
                ...
                <div class="px-6 py-2">
                    <div class="grid gap-2 grid-cols-[repeat(auto-fit,minmax(0,1fr))]">
                        <button  onClick={()=>setConfarmDelete(false)}
                        ...
                        <button onClick={ () => handlerDeleteIcon(index)}
...
export default DeleteSaddleCon
