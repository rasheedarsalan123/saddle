...
const DetailPage = ({
  ...
  return (
    <div className="flex justify-center items-center top-0 left-0 right-0 fixed z-10 w-[100%] h-[100%]">
      ...
      <div
        ref={modalRef}
        className="relative  w-[380px] h-[440px] flex flex-col justify-center  items-center z-10 bg-white 
      ...
      >
        ...
        <div className=" flex   items-center justify-center">
         ...
         justify-center items-center text-center "
          >
            <h1 className="add-horse text-[48px]  text-[#2b364b] font-[700]">ADD HORSE</h1>
          </div>
        ...
        <div className=" flex  ">
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex  flex-col relative h-[56px]">         
              <label    htmlFor="Name" className=" absolute top-[10px]
            ...
            <div className="flex  flex-col relative h-[56px] ">
            <label htmlFor="Birth Date" className=" absolute top-[10px]
          ...
          <div
            className="bg-[#d9d9d9] items-center text-center w-[90px] justify-center
             pt-9 pl-9 rounded-xl mt-1
        ...
        <div className=" flex justify-center gap-6 mt-4">
          <button
            onClick={handlerSave}
            className="bg-[#2b364b]  font-[Montserrat] text-white p-[2px] rounded-[30px] w-[145px] "
          >
            Save
          </button>
          <button
            className=" border-solid border-2 border-[#2b364b] text-[#2b364b] 
            font-[Montserrat] font-[400] p-[6px] h-[42px] rounded-[30px] w-[145px]"
            onClick={() => setAddSaddle(false)}
          >
            Cancel
          </button>
