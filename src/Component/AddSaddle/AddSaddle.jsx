       ...
       flex-wrap sm:flex items-center  w-full h-auto  justify-between "
        >
          ...
          "
            ...
            <div className=" md:gap-10 pt-5 font-[Montserrat]">
              {" "}
              <h3>Find the information you have added below.</h3>{" "}
            </div>{" "}
          </div>
          <div className=" flex  ">
...
>
  Delete
        ...
        >
          <div
            className="flex flex-col w-[313px]  md:w-[427px]  justify-between rounded-lg  md:h-[261px] h-[200px]
           p-5  border-solid border-2 border-blue-500"
          >
            <div className="flex   items-center text-center justify-between ">
              <div className="flex  ">
                <h1 className="md:text-[44px] text-[22px] text-[#2b364b] font-[700] add-horse">
                  ADD HORSE
                </h1>
              </div>
              <div
       ...
       items-center"
                  >
                    ...
                    <div className="relative w-full cursor-pointer pointer-events-none transition my-auto p-4">
                      <div
                        className="w-full py-2 bg-white cursor-default pointer-events-auto
