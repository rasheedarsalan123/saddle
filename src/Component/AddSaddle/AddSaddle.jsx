...
const AddSaddle = () => {
  ...
  const [inputVal, setInputVal] = useState({ Name: "", FatherName: "" });
    ...
    <>
      <div className="flex justify-center flex-col w-[full] ml-5 flex-wrap gap-5">
        ...
        <div className="flex w-[full] justify-center flex-wrap gap-3">
          ...
          <div className="flex w-[900px] gap-5 justify-start flex-wrap">
            {localStorageData &&
                ...
                <>
                  ...
                  >
                    ...
                    <div className="flex gap-4 items-center cursor-pointer">
                      ...
                      <button className="font-bold border border-black rounded p-1 h-[30px] text-blue-900 gap-5">
                        Add
                      </button>
                    </div>
